...
const Experience: React.FC = () => {
  return (
    <section id="experience" className="py-24 bg-dark border-t border-zinc-900">
      <div className="container mx-auto px-6 max-w-6xl">
        
        <div className="grid lg:grid-cols-2 gap-16">
            {/* Research */}
            <div>
              <h2 className="text-2xl font-bold text-light mb-12 flex items-center gap-3 border-b border-zinc-800 pb-4">
