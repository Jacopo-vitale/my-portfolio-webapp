...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative w-full py-32 md:py-48 flex flex-col justify-center items-center overflow-hidden">
      ...
      {/* Decorative Elements - Subtle Animation */}
      <motion.div 
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 2, ease: "easeOut" }}
        className="absolute top-0 right-0 w-[500px] h-[500px] bg-zinc-800/20 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2 pointer-events-none"
      ></motion.div>
      <motion.div 
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 2, delay: 0.5, ease: "easeOut" }}
        className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-accent/10 rounded-full blur-[80px] translate-y-1/2 -translate-x-1/2 pointer-events-none"
      ></motion.div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <motion.h1 
            ...
            className="text-5xl md:text-8xl font-bold text-white mb-8 tracking-tighter leading-tight drop-shadow-lg"
        >
          {PROFILE.name}
        </motion.h1>
        ...
        <motion.h2 
            ...
            className="text-xl md:text-3xl text-zinc-300 font-light mb-10 max-w-3xl mx-auto tracking-wide"
        >
          {PROFILE.title}
        </motion.h2>
        ...
        <motion.div 
            ...
            className="flex items-center justify-center gap-2 text-zinc-500 text-xs uppercase tracking-widest"
        >
